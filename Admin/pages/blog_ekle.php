...
if (@$_POST["submit"]) {
    ...
    $ekle = $db->prepare("INSERT INTO `bloglar`( `baslik`, `alt_baslik`, `aciklama`,  `aktif`, `tur`)VALUES
    (:baslik,:alt_baslik,:aciklama,:aktif,:tur)");
    ...
    $ekle->bindValue(":tur",$tur, PDO::PARAM_INT);
    if ($ekle->execute()); {
                                ...
                                <div class="col-lg-6">
                                    <form role="form" action="" method="POST" entype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="alt_baslik"placeholder="Alt Başlık ">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="radio">
                                                <label>
                                                    <input type="radio" name="tur"  value="1">Oyun İnceleme
                                                </label>
                                            </div>
                                            <div class="radio">
                                                <label>
                                                    <input type="radio" name="tur"  value="0">Kitap İnceleme
                                                </label>
                                            </div>
