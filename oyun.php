...
<html lang="tr">
    ...
    <body>
        ...
        ?>
        <!-- Page Header-->
        <header class="masthead" style="background-image: url('assets/img/oyun.jpg')">
        ...
        <div class="container px-4 px-lg-5">
            <div class="row gx-4 gx-lg-5 justify-content-center">
                <div class="col-md-10 col-lg-8 col-xl-7">
                <?php 
                     $cek=$db->prepare("SELECT * FROM `bloglar` WHERE `tur`=:tur ORDER BY  `id` DESC ");
                     $cek->bindValue(":tur",1,PDO::PARAM_INT);
                     $cek->execute();
